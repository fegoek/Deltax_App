...
class OrganisationTaxCalculatorWidget extends StatefulWidget {
  const OrganisationTaxCalculatorWidget({super.key});

  @override
  State<OrganisationTaxCalculatorWidget> createState() => _OrganisationTaxCalculatorWidgetState();
}

class _OrganisationTaxCalculatorWidgetState extends State<OrganisationTaxCalculatorWidget> {
  @override
        ...
        leading: Builder(builder: (context) {
          return IconButton(onPressed: (){
            Navigator.push(context,
             MaterialPageRoute(builder: (context) => const OrganPaymentScreen()));
